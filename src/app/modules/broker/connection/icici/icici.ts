...
import { IciciDirectBroker } from '../../../../services/brokers/icici.service';
import { isPlatformServer } from '@angular/common';
import { environment } from '../../../../../environments/environment';

@Component({
  selector: 'aq-broker-icici',
  templateUrl: 'icici.html',
  standalone: true,
  imports: [
    ButtonModule,
...
export class IciciDirectComponent implements OnInit {
  constructor(
    ...
    private readonly iciciBroker: IciciDirectBroker
  ) {}
